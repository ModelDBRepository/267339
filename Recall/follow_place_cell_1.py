@nrp.MapSpikeSink("Place_1",nrp.brain.place_cells[1:2],nrp.spike_recorder)
...
def follow_place_cell_1 (t,Place_1,brown_left_output,brown_right_output,var_angle):
