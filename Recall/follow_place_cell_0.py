@nrp.MapSpikeSink("Place_0",nrp.brain.place_cells[0:1],nrp.spike_recorder)
...
def follow_place_cell_0 (t,Place_0,brown_left_output,brown_right_output,var_angle):
    ...
    if Place_0.spiked:
        if(var_angle.value <= 20 and var_angle.value > 0):
            return geometry_msgs.msg.Twist(linear=geometry_msgs.msg.Vector3(2,0,0))
        elif(var_angle.value == 0 or var_angle.value >200):
            return geometry_msgs.msg.Twist(angular=geometry_msgs.msg.Vector3(0,0,2.0))
        elif(var_angle.value <=200 and var_angle.value > 20):
            return geometry_msgs.msg.Twist(angular=geometry_msgs.msg.Vector3(0,0,-2.0))