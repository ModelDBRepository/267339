...
def follow_cyan (t,cyan_left,cyan_right,turquoise,turn_f,vision_blu,vision_red,vision_black,vision_green,vision_cyan,vision_yellow,vision_purple,vision_indaco):
    if(turn_f.value == 0 and (vision_red.value == 0 and vision_blu.value == 0 and vision_green.value == 0 and vision_black.value == 0 and vision_purple.value == 0 and vision_indaco.value == 0 and vision_yellow.value == 0)):
        if (cyan_left.value > 0.001 and cyan_right.value > 0.001):
            vision_cyan.value = 1
        if(cyan_left.value > 0.001 and cyan_right.value > 0.001):
